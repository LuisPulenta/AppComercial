...
namespace CADAppComercial
{
    public class CADBodegaProducto
    {
        ...
        public static CADBodegaProducto BodegaProductoGetBodegaProductoByIDBodegaAndIDProducto(int IDBodega, int IDProducto)
        {
            ...
            DSAppComercial.BodegaProductoDataTable miTabla = adaptador.BodegaProductoGetBodegaProductoByIDBodegaAndIDProducto(IDBodega, IDProducto);
            ...
            {
                DSAppComercial.BodegaProductoRow miRegistro = (DSAppComercial.BodegaProductoRow)miTabla.Rows[0];
