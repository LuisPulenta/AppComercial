...
namespace CADAppComercial
{
    public class CADProducto
    {
        ...
        public static CADProducto ProductoGetProductoByIDProducto(int IDProducto)
        {
            ...
            DSAppComercial.ProductoDataTable miTabla = adaptador.ProductoGetProductoByIDProducto(IDProducto);
            ...
            {
                DSAppComercial.ProductoRow miRegistro = (DSAppComercial.ProductoRow)miTabla.Rows[0];
