...
namespace AppComercial.Movimientos
{
    public partial class frmDevolucionProveedores : Form
    {
        ...
        {
            this.proveedorTableAdapter.FillBy2(this.dSAppComercial.Proveedor);
            this.compraTableAdapter.Fill(this.dSAppComercial.Compra);
        ...
        private void compraComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            CADAppComercial.DSAppComercial.CompraDetalleDataTable miTabla = CADCompraDetalle.CompraDetalleGetCompraDetalleByIDCompra(miCompra.IDCompra);
            foreach (CADAppComercial.DSAppComercial.CompraDetalleRow miRegistro in miTabla.Rows)
            {
